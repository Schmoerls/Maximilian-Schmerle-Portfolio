...
public class ConstructedMealsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

    private final ViewHolderListener listener;

    private final TextView mealName;

    public ConstructedMealsViewHolder(@NonNull View itemView, ViewHolderListener listener) {
        super(itemView);
    ...
    public void bindView(String meal){
